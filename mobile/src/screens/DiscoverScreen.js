...
export default function DiscoverScreen() {
  ...
  if (!currentUser) return (
    <View style={styles.center}>
      ...
      <Text style={styles.doneText}>Simdilik herkesi gordin!</Text>
      <Text style={styles.doneSubText}>Daha fazla film ekleyerek eslesmeni artir</Text>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.cardContainer}>
        ...
        >
          ...
          <View style={styles.cardInner}>
            ...
            {currentUser.username && <Text style={styles.cardUsername}>@{currentUser.username}</Text>}
            {currentUser.bio && <Text style={styles.cardBio}>{currentUser.bio}</Text>}
            ...
            {currentUser.movies?.length > 0 && (
              <View style={styles.moviesList}>
                <Text style={styles.moviesTitle}>İzledikleri</Text>
      ...
      <View style={styles.actions}>
        <TouchableOpacity style={[styles.actionBtn, styles.nopeBtn]} onPress={triggerSwipeLeft} disabled={!!actionLoading}>
...
const styles = StyleSheet.create({
  ...
  badge: { position: 'absolute', top: 24, padding: 8, paddingHorizontal: 16, borderRadius: 8, borderWidth: 3, zIndex: 10 },
  ...
  avatarLarge: { width: 90, height: 90, borderRadius: 45, backgroundColor: '#E50914', justifyContent: 'center', alignItems: 'center', marginBottom: 14, overflow: 'hidden' },
  ...
  scoreBadge: { backgroundColor: '#0f0f0f', borderRadius: 12, paddingVertical: 10, paddingHorizontal: 18, alignItems: 'center', borderWidth: 1, borderColor: '#2a2a2a' },
  ...
  actions: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 32, paddingBottom: 24, paddingTop: 8 },
